...
def cal_P(tlen):
    ...
    for t in t_values:
        ...
        P3 = P3 + dP3 * dt
        P1_list.append(P1)
        P2_list.append(P2 / 2.7 - 500)
        P3_list.append(P3 / 1.2)

    with open('P1_control.pkl', 'wb') as file:
...
# 对象之间的影响值alpha(controled)
alpha0 = 1e-2   # 影响力度
alpha_21a = 0.08   # 鱼群对七鳃鳗幼虫影响(+)
alpha_21c = 1   # 鱼群对七鳃鳗成虫影响(+)
alpha_31 = -1   # 寄生虫对七鳃鳗的影响(-)
alpha_1c2 = -26  # 成虫对鱼群的寄生影响(-)
alpha_1a2 = 1e-19   # 幼虫对鱼群的影响甚微(+)
alpha_32 = -9e-4   # 寄生虫对鱼群的影响 (-)
alpha_13 = 10  # 七鳃鳗对寄生虫影响 (+)
